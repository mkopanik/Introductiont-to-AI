...
class Tank:
    ...
    def stop(self):
        ...
        # it serves a specific purpose like engaging a braking mechanism, especially since the force on the main
        # wheels was set to 0 in Step 1. In some simulation configurations, rapidly setting a target velocity while
        # the joint force is low or zero can simulate the effect of braking.
    ...
    def turn_left_circle(self, velocity):
        self.go()
        self.leftvelocity = 20 * (velocity / 8)
    ...
    def turn_right_circle(self, velocity):
        self.go()
        self.rightvelocity = 20 * (velocity / 8)
